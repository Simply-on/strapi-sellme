...
export interface ApiCareersPageCareersPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    job_listings: Schema.Attribute.Component<'shared.job', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero_cta_label: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Request a demo'>;
    hero_subtitle: Schema.Attribute.Text;
    hero_title_line1: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Sustainability insights,'>;
    hero_title_line2: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    testimonial_role: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value_cards: Schema.Attribute.Component<'shared.value-card', true>;
  };
}
